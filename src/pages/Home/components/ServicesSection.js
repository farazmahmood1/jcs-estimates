...
const services = [
  ...
  { icon: "assets/img/icon/steel-beam.png", title: "Metals", description: "Comprehensive metal framing and structural component estimation for durability and compliance." },
  ...
  { icon: "assets/img/icon/door-window.png", title: "Openings", description: "Estimates for doors, windows, and other openings including materials, labor, and sealing." },
  ...
  { icon: "assets/img/icon/specialty.png", title: "Specialties", description: "Specialized items such as lockers, lab benches, signage, and custom-built components." },
  { icon: "assets/img/icon/equipment.png", title: "Equipment", description: "Estimation for built-in or fixed equipment such as kitchen appliances, lifts, and industrial gear." },
  ...
  { icon: "assets/img/icon/special-construction.png", title: "Special Construction", description: "Estimates for specialized structures like clean rooms, vaults, or blast-resistant buildings." },
  { icon: "assets/img/icon/elevator.png", title: "Conveying Equipment", description: "Estimation for elevators, escalators, lifts, and related mechanical systems." },
  ...
  { icon: "assets/img/icon/plumbing.png", title: "Plumbing", description: "Plumbing system estimates covering piping, fixtures, water heating, and drainage." },
  { icon: "assets/img/icon/hvac.png", title: "HVAC", description: "Heating, Ventilation, and Air Conditioning system estimation for comfort and air quality." },
  { icon: "assets/img/icon/electrical.png", title: "Electrical", description: "Full electrical system estimates including wiring, panels, lighting, and power distribution." },
